...
<form method="POST" action="<c:url value="/get-invoices-by-customerName-jsp"/>">
	<hr>
	<label for="filterByCustomerNameID">Filter by Customer Name:</label>
	<input id="filterByCustomerNameID" name="filterByCustomerName" type="text"/><br/><br/>
