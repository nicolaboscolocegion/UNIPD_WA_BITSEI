...
public class GetProductRR extends AbstractRR {
    ...
    protected void doServe() throws IOException {
        ...
        try {
            ...
            LOGGER.error("Cannot fetch product: unexpected error while accessing the database.", ex.getMessage());
            m = new Message("Cannot fetch product: unexpected error while accessing the database.", "E5A1", "");
