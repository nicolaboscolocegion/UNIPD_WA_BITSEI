 ...
 */
public class InvoiceContainer extends AbstractResource {
    /**
    ...
    /**
     * The business name associated to the id of the customer
     */
    ...
    /**
     * Returns the business name of the customer associated to the invoice.
     *
     * @return the business name of the customer associated to the invoice
     */
    ...
    /**
     * Creates a {@code InvoiceContainer} from its JSON representation.
     *
     * @param in the input stream containing the JSON document.
     * @return the {@code InvoiceContainer} created from the JSON representation.
     * @throws IOException if something goes wrong while parsing.
     */
    public static InvoiceContainer fromJSON(final InputStream in) throws IOException {
                ...
                if (jp.getCurrentToken() == JsonToken.FIELD_NAME) {
                    switch (jp.getCurrentName()) {
                        ...
                        case "warning_pdf_file":
                            ...
                            jWarning_pdf_file = jWarning_pdf_file.replaceAll("\\s+$", "").trim(); // remove all the whitespaces at the end
                            break;
                        case "invoice_number":
                            jp.nextToken();
                        ...
                        case "invoice_pdf_file":
                            ...
                            jInvoice_pdf_file = jInvoice_pdf_file.replaceAll("\\s+$", "").trim(); // remove all the whitespaces at the end
                            break;
                        case "invoice_xml_file":
                            jp.nextToken();
                            jInvoice_xml_file = jp.getText();
                            jInvoice_xml_file = jInvoice_xml_file.replaceAll("\\s+$", "").trim(); // remove all the whitespaces at the end
                            break;
                        case "total":
                            jp.nextToken();
        ...
        return new InvoiceContainer(jInvoice_id, jCustomer_id, jStatus, jWarning_number, jWarning_date, jWarning_pdf_file, jInvoice_number, jInvoice_date, jInvoice_pdf_file, jInvoice_xml_file, jTotal, jDiscount, jPension_fund_refund, jHas_stamp, jBusiness_name);
    }
