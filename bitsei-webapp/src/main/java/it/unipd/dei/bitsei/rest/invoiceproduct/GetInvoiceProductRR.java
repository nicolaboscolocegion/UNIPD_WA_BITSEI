...
public class GetInvoiceProductRR extends AbstractRR {
    ...
    protected void doServe() throws IOException {
        ...
        try {
            ...
            LOGGER.error("Cannot fetch invoice product: unexpected error while accessing the database.", ex.getMessage());
            m = new Message("Cannot fetch invoice product: unexpected error while accessing the database.", "E5A1", "");
