...
public class DeleteInvoiceProductRR extends AbstractRR {
    ...
    protected void doServe() throws IOException {
        ...
        try {
            ...
            LOGGER.error("Cannot delete invoice product: unexpected error while accessing the database.", ex.getMessage());
            m = new Message("Cannot delete invoice product: unexpected error while accessing the database.", "E5A1", "");
