...
public class ListInvoiceByFiltersDAO extends AbstractDAO<List<InvoiceContainer>> {
    ...
    protected void doAccess() throws SQLException {
        ...
        String init_query = "SELECT i.*, c.business_name FROM bitsei_schema.\"Invoice\" AS i JOIN bitsei_schema.\"Customer\" AS c ON i.customer_id = c.customer_id JOIN bitsei_schema.\"Company\" AS cmp ON c.company_id = cmp.company_id WHERE cmp.owner_id = ? AND cmp.company_id = ?";
